          ...
          <tbody className="divide-y divide-slate-200 bg-white text-sm">
            {filteredItems.map((item) => (
              <tr key={item.id} className={`transition-colors hover:bg-slate-50 ${selected.has(item.id) ? "bg-purple-50/60" : ""}`}>
                ...
                <td className="sticky left-[250px] z-10 w-[300px] max-w-[300px] min-w-[300px] whitespace-normal break-words bg-white px-4 py-3 text-slate-700 shadow-[1px_0_0_#e2e8f0] group-hover:bg-slate-50"><InlineEdit id={item.id} field="keterangan" type="text" initialValue={item.keterangan} /></td>
